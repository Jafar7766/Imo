...
public class FragmentContact extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        lstContact.add(new Contact("New Contacts","Add", R.drawable.ic_baseline_person_add_24));
        lstContact.add(new Contact("New Group Chat","Add", R.drawable.ic_baseline_chat_24));
